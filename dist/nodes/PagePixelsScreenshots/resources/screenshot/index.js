    ...
    },
    {
        ...
        routing: {
            send: {
                ...
                value: '={{$value.filter(item => item.action !== undefined && item.action !== "").map(item => item.action)}}',
            },
        },
    },
    {
    ...
    },
    {
        ...
        routing: {
            send: {
                type: 'query',
                property: 'headers',
                value: '={{$value.filter(item => item.header !== undefined && item.header !== "").map(item => item.header)}}',
            },
        },
    },
    {
        ...
        routing: {
            send: {
                type: 'query',
                property: 'cookies',
                value: '={{$value.filter(item => item.cookie !== undefined && item.cookie !== "").map(item => item.cookie)}}',
            },
        },
    },
    {
